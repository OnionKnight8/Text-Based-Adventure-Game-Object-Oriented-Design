...
public class FinalProject {
    ...
    public FinalProject() throws Exception {
        ...
        PrintStream printStream = new PrintStream(new TextOutput(gui.outputArea));
         ...
         */
        gui.inputArea.addActionListener(new ActionListener() {
            @Override
            public void inputEntered(ActionEvent event) {
                synchronized(queue) {
                    queue.add(gui.inputArea.getText());
                    queue.notify();
                }
            }
        });
